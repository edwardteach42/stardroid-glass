...
public class SplashScreenActivity extends Activity {
	private final static String TAG = MiscUtil
			.getTag(SplashScreenActivity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Animation fadeAnimation = AnimationUtils.loadAnimation(this,
				R.anim.fadeout);
	...
	public void onStart() {
		...
		Analytics.getInstance(this).trackPageView(
				Analytics.SPLASH_SCREEN_ACTIVITY);
	}
